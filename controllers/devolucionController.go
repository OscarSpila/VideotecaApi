...
func (controller DevolucionController) Find(context *gin.Context) {
...
func (controller DevolucionController) Update(context *gin.Context) {
...
func (controller DevolucionController) Delete(context *gin.Context) {
	ID := context.Param("generoID")
